...
export default function AttendanceHistorySection({ permissions }) {
 ...
 <tr>
 <th className="py-3 pl-4 pr-3 text-left text-xs font-medium text-ink-500 uppercase tracking-wider sm:pl-0">
 Date
 </th>
 <th className="px-3 py-3 text-left text-xs font-medium text-ink-500 uppercase tracking-wider">
 Department
 </th>
 <th className="px-3 py-3 text-left text-xs font-medium text-ink-500 uppercase tracking-wider">
 Total
 ...
 <td className="whitespace-nowrap px-3 py-3 font-medium text-forest">
 {present}
 </td>
 <td className="whitespace-nowrap px-3 py-3 font-medium text-brick">
 {absent}
 </td>
 <td className="whitespace-nowrap px-3 py-3 text-ink-600">
 {pct}
 ...
 <td className="whitespace-nowrap px-3 py-3 text-ink-800">
 {name}
 </td>
 <td className="whitespace-nowrap px-3 py-3 text-ink-600">
 {dept}
 ...
 <th
 key={k}
 className="px-3 py-3 text-left text-xs font-medium text-ink-500 uppercase tracking-wider first:pl-0"
 >
 {k}
 </th>
 ))}
