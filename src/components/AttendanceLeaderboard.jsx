...
export default function AttendanceLeaderboard({
 ...
 <thead>
 <tr>
 <th className="py-2 pl-4 pr-3 text-left text-xs font-medium text-ink-500 uppercase tracking-wider sm:pl-0">
 Rank
 </th>
 ...
 <td className="whitespace-nowrap py-2 pl-4 pr-3 text-sm font-medium text-ink-900 sm:pl-0">
 {index + 1}
 </td>
 ...
 <td className="whitespace-nowrap px-3 py-2 text-sm text-ink-500">
 <span
 className={`font-semibold ${
 isTop ? "text-forest" : "text-brick"
 }`}
 >
 ...
 <span className="font-medium text-ink-700">{performer.trend}</span>
 ) : performer.trend === "up" ? (
