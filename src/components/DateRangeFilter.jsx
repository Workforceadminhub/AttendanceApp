  ...
  return (
    <div className={`flex flex-wrap items-center gap-3 ${className}`}>
      ...
      <select
        ...
        className="rounded-md border border-gray-300 px-3 py-2 text-sm shadow-sm focus:border-black focus:ring-1 focus:ring-black"
      >
        {PRESETS.map((preset) => (
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-2">
            <DatePicker
              ...
              className="rounded-md border border-gray-300 px-3 py-2 text-sm w-full focus:border-black focus:ring-1 focus:ring-black"
