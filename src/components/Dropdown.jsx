...
const Select = forwardRef(
 ...
 className={clsx(
 { "border border-ink-200": showBorder },
 inputClassName,
 { "!bg-cream cursor-not-allowed": disabled },
 "inline-block w-full py-2 px-4 rounded-md bg-white focus:ring-0 focus:outline-0 h-max min-h-[44px]"
 )}
