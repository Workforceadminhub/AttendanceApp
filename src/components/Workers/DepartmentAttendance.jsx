...
export default function DepartmentAttendance() {
 ...
 {isHistoryMode && (
 <span className="inline-flex items-center rounded-full bg-ink-100 px-2.5 py-0.5 text-xs font-medium text-ink-900">
 Viewing history
 </span>
 )}
 <span className="text-sm font-medium text-ink-700">Date Filter</span>
 <DatePicker
 id="sundayDatePicker"
 ...
 className="rounded-lg border border-ink-300 bg-white px-3 py-2 text-sm text-ink-700 focus:outline-none focus:ring-2 focus:ring-ink-900/10 focus:border-ink-900 cursor-pointer"
