        ...
        <div className="max-w-4xl mx-auto">
          <div className="mb-6">
            <div className="flex items-center gap-2 text-sm text-gray-500 mb-1">
              ...
              <span>/</span>
              <span className="font-semibold text-gray-900">Add Worker</span>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow border p-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">
                    Birth Date (day & month) <span className="text-red-500">*</span>
                  </label>
                  <BirthDatePicker
              ...
              <div className="flex justify-end gap-3 pt-4 border-t border-gray-200">
                <Link
                  to={workersUrl}
                  className="inline-flex items-center justify-center min-w-[140px] px-6 py-2.5 rounded-lg text-sm font-medium text-gray-700 bg-white border border-gray-300 hover:bg-gray-50"
                >
                  Cancel
                </Link>
                <button
                  type="submit"
                  disabled={isLoading}
                  className="inline-flex items-center justify-center min-w-[140px] px-6 py-2.5 rounded-lg text-sm font-semibold text-white bg-green-600 hover:bg-green-700 disabled:opacity-50 disabled:cursor-not-allowed"
                >
