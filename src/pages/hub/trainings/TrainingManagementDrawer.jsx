  ...
  return (
    ...
    >
      <form id="training-drawer-form" onSubmit={handleSubmit} className="space-y-5" noValidate>
        ...
        <SectionHeading>Capacity &amp; batch</SectionHeading>
        <div className="grid grid-cols-2 gap-4">
          <div>
        ...
        <div>
          ...
          <p className="text-xs text-ink-500 mt-1">
            The certificate number and date issued are generated by the system when the worker is marked completed; they are not typed into the template.
          </p>
          <p className="text-xs text-ink-500 mt-1">
